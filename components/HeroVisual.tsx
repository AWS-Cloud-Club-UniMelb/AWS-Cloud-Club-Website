...
const INNER_RADIUS    = 1.30
const OUTER_RADIUS    = 1.60
const RING3_RADIUS    = 1.95
const RING4_RADIUS    = 2.30
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (const s of satellites) {
        ...
        s.sprite.position.set(Math.cos(a) * s.radius, 0, Math.sin(a) * s.radius)
      }
...
function TypewriterTitle() {
  ...
  return (
    <h2
      ...
      style={{
        color: '#F0ECFF',
        textShadow: '0 2px 20px rgba(10,10,15,0.8), 0 0 40px rgba(139,92,246,0.3)',
      }}
    >
      <span>{line1}{cursorLine === 1 && cursor}</span>
      <br />
      <span>{line2}{cursorLine === 2 && cursor}</span>
    </h2>
  )
}
...
export default function HeroVisual() {
  return (
    <div className="relative w-full aspect-square max-w-[1400px] flex items-center justify-center select-none">
      ...
      <div
        ...
        style={{ width: 560, height: 560, border: '1px solid rgba(107,63,212,0.18)' }}
      />
