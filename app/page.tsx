        ...
        <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <AnimatedSection delay={0.1} className="flex-1">
            <div className="flex flex-col items-start text-left">
              ...
              <h2
                className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter leading-tight mb-4"
                style={{ color: "#F0ECFF" }}
              >
        ...
        <AnimatedSection>
          <div className="mb-16">
            ...
            >
              ...
              <br />
              <span style={{ color: "#5C5275" }}>go deep on AWS.</span>
            </h2>
          </div>
        </AnimatedSection>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {stats.map((s, i) => (
              <AnimatedSection key={s.label} delay={i * 0.07}>
                <div>
                  <p
                    className="text-4xl md:text-5xl font-bold tracking-tighter tabular-nums mb-2"
                    style={{ color: "#F0ECFF" }}
                  >
      ...
      <section className="py-32 max-w-7xl mx-auto px-6">
        <AnimatedSection>
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, #1A1535 0%, #12101E 60%, #0A0A0F 100%)",
              border: "1px solid rgba(139,92,246,0.2)",
          ...
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(107,63,212,0.12) 0%, transparent 70%)",
            ...
            <div className="relative z-10 max-w-[56ch]">
              ...
              <h2
                className="text-4xl md:text-5xl font-bold tracking-tighter leading-tight mb-6"
                style={{ color: "#F0ECFF" }}
              >
                Ready to build on
                <br />
